#!/bin/bash
# SeoSales agent startup script
# SEO/AEO es Sales outreach agent

INSTALL_DIR="$(cd "$(dirname "$0")/.." && pwd)"
AGENT_DIR="$INSTALL_DIR/agents/sesa"
SESSION="agent-sesa"
...
echo "SeoSales agent started in tmux session: $SESSION"
