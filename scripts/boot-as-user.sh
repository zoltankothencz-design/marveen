...
# NOTA: a dashboard (node dist/index.js) inditasat a systemd marveen-dashboard.service kezeli.
# Ez a script csak a tmux sessionoket inditja.
...
# Dashboard: systemd kezeli (marveen-dashboard.service)
# NE inditsd kozvetlenul node dist/index.js-t -- konfliktust okoz a process-lock miatt!
echo "$(date -Iseconds) [user] dashboard: systemd service kezeli" >> "$LOG"
